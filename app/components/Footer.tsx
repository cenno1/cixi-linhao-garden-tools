  ...
  return (
    <footer className="site-footer">
      <div className="container footer-grid">
        ...
        <div><h3>Work With Us</h3><a href="/about#oem">OEM / ODM</a><a href="/about#quality">Quality Control</a><a href="/resources">Buyer Resources</a><a href="/contact">Request a Quote</a></div>
