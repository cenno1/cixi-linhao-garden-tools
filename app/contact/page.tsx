...
export default function ContactPage() {
  ...
  return <><Header /><main><section className="page-hero contact-hero"><div className="container"><span className="eyebrow eyebrow-light">Request a quote</span><h1>Tell us what your market needs.</h1><p>Product, target quantity and packaging context help us give you a useful response faster.</p></div></section><section className="section"><div className="container contact-layout"><div className="contact-aside"><span className="eyebrow">Direct contact</span><h2>Prefer an instant conversation?</h2><p>Send a short WhatsApp message with your company, market and product interest. Our team will continue the discussion there.</p><TrackedWhatsAppLink className="button whatsapp-button" href={`https://wa.me/${number}?text=${encodeURIComponent("Hello CIXI LINHAO, I would like to discuss a B2B garden product inquiry.")}`} placement="contact_page_primary">Chat on WhatsApp</TrackedWhatsAppLink><div className="contact-expect"><strong>What happens next</strong><span>1. We review your requirements</span><span>2. We clarify specifications</span><span>3. We propose products and next steps</span></div></div><InquiryForm compact /></div></section></main><Footer /><WhatsAppFloat /></>;
}
