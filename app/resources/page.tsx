...
export const metadata: Metadata = { title: "Buyer Resources", description: "Practical sourcing guidance for garden tools, watering fittings and private-label product programs.", alternates: { canonical: "/resources" } };
