...
export const metadata: Metadata = { title: "Products", description: "Explore CIXI LINHAO watering products, brass fittings, garden hand tools and customizable tool kits.", alternates: { canonical: "/products" } };
